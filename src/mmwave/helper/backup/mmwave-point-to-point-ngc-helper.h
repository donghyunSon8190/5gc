...
#ifndef MMWAVE_POINT_TO_POINT_NGC_HELPER_H
#define MMWAVE_POINT_TO_POINT_NGC_HELPER_H
 ...
 * PointToPoint links. 
 */
class MmWavePointToPointNgcHelper : public NgcHelper
{
public:
   ...
   * Constructor
   */
  MmWavePointToPointNgcHelper ();

  /** 
   * Destructor
   */  
  virtual ~MmWavePointToPointNgcHelper ();
...
#endif // MMWAVE_POINT_TO_POINT_NGC_HELPER_H
