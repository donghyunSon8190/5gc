...
#include <ns3/ngc-sgw-pgw-application.h>
...
NS_LOG_COMPONENT_DEFINE ("MmWavePointToPointNgcHelper");

NS_OBJECT_ENSURE_REGISTERED (MmWavePointToPointNgcHelper);


MmWavePointToPointNgcHelper::MmWavePointToPointNgcHelper ()
    ...
    m_s1apUdpPort (36412)
{
  ...
  // create NgcSgwPgwApplication
  m_sgwPgwApp = CreateObject<NgcSgwPgwApplication> (m_tunDevice, sgwPgwS1uSocket);
  m_sgwPgw->AddApplication (m_sgwPgwApp);
  
  // connect SgwPgwApplication and virtual net device for tunneling
  m_tunDevice->SetSendCallback (MakeCallback (&NgcSgwPgwApplication::RecvFromTunDevice, m_sgwPgwApp));
 ...
 // create S1apMme object and aggregate it with the m_mmeNode
  ...
  // create NgcMmeApplication and connect with SGW via S11 interface
...
TypeId
MmWavePointToPointNgcHelper::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::MmWavePointToPointNgcHelper")
    .SetParent<NgcHelper> ()
    .SetGroupName("mmWave")
    .AddConstructor<MmWavePointToPointNgcHelper> ()
    .AddAttribute ("S1uLinkDataRate", 
                   "The data rate to be used for the next S1-U link to be created",
                   DataRateValue (DataRate ("10Gb/s")),
                   MakeDataRateAccessor (&MmWavePointToPointNgcHelper::m_s1uLinkDataRate),
                   MakeDataRateChecker ())
    .AddAttribute ("S1uLinkDelay", 
                   "The delay to be used for the next S1-U link to be created",
                   TimeValue (Seconds (0.001)),
                   MakeTimeAccessor (&MmWavePointToPointNgcHelper::m_s1uLinkDelay),
                   MakeTimeChecker ())
    .AddAttribute ("S1uLinkMtu", 
                   ...
                   UintegerValue (2000),
                   MakeUintegerAccessor (&MmWavePointToPointNgcHelper::m_s1uLinkMtu),
                   MakeUintegerChecker<uint16_t> ())
    .AddAttribute ("S1apLinkDataRate", 
                   "The data rate to be used for the S1-AP link to be created",
                   DataRateValue (DataRate ("10Gb/s")),
                   MakeDataRateAccessor (&MmWavePointToPointNgcHelper::m_s1apLinkDataRate),
                   MakeDataRateChecker ())
    .AddAttribute ("S1apLinkDelay", 
                   "The delay to be used for the S1-AP link to be created",
                   TimeValue (MilliSeconds (15)),
                   MakeTimeAccessor (&MmWavePointToPointNgcHelper::m_s1apLinkDelay),
                   MakeTimeChecker ())
    .AddAttribute ("S1apLinkMtu", 
                   "The MTU of the next S1-AP link to be created",
                   UintegerValue (10000),
                   MakeUintegerAccessor (&MmWavePointToPointNgcHelper::m_s1apLinkMtu),
                   MakeUintegerChecker<uint16_t> ())
    .AddAttribute ("X2LinkDataRate",
                   "The data rate to be used for the next X2 link to be created",
                   DataRateValue (DataRate ("100Gb/s")),
                   MakeDataRateAccessor (&MmWavePointToPointNgcHelper::m_x2LinkDataRate),
                   MakeDataRateChecker ())
    .AddAttribute ("X2LinkDelay",
                   "The delay to be used for the next X2 link to be created",
                   TimeValue (Seconds (0.001)),
                   MakeTimeAccessor (&MmWavePointToPointNgcHelper::m_x2LinkDelay),
                   MakeTimeChecker ())
    .AddAttribute ("X2LinkMtu",
                   ...
                   UintegerValue (10000),
                   MakeUintegerAccessor (&MmWavePointToPointNgcHelper::m_x2LinkMtu),
                   MakeUintegerChecker<uint16_t> ())
  ;
  return tid;
}
...
void
MmWavePointToPointNgcHelper::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
void
MmWavePointToPointNgcHelper::AddEnb (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId)
{
...
/*
  ...
  Ptr<NgcEnbApplication> enbApp = CreateObject<NgcEnbApplication> (enbLteSocket, enbS1uSocket, enbAddress, sgwAddress, cellId);
...
*/
  ...
  NS_LOG_INFO ("create NgcEnbApplication");
  Ptr<NgcEnbApplication> enbApp = CreateObject<NgcEnbApplication> (enbLteSocket, enbS1uSocket, enbAddress, sgwAddress, cellId);
  //Ptr<NgcEnbApplication> enbApp = CreateObject<NgcEnbApplication> (enbLteSocket, enbS1uSocket, enbAddress, serverAddr, cellId);
...
void
MmWavePointToPointNgcHelper::AddX2Interface (Ptr<Node> enb1, Ptr<Node> enb2)
{
...
void 
MmWavePointToPointNgcHelper::AddUe (Ptr<NetDevice> ueDevice, uint64_t imsi)
{
...
uint8_t
MmWavePointToPointNgcHelper::ActivateEpsBearer (Ptr<NetDevice> ueDevice, uint64_t imsi, Ptr<NgcTft> tft, EpsBearer bearer)
{
...
uint8_t
MmWavePointToPointNgcHelper::ActivateEpsBearer (Ptr<NetDevice> ueDevice, Ptr<NgcUeNas> ueNas, uint64_t imsi, Ptr<NgcTft> tft, EpsBearer bearer)
{
  NS_LOG_FUNCTION (this << ueDevice << imsi);
...
Ptr<Node>
MmWavePointToPointNgcHelper::GetPgwNode ()
{
  return m_sgwPgw;
}
...
Ptr<Node>
MmWavePointToPointNgcHelper::GetMmeNode ()
{
  return m_mmeNode;
}

Ipv4InterfaceContainer 
MmWavePointToPointNgcHelper::AssignUeIpv4Address (NetDeviceContainer ueDevices)
{
...
Ipv4Address
MmWavePointToPointNgcHelper::GetUeDefaultGatewayAddress ()
{
