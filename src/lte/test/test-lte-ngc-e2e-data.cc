...
NS_LOG_COMPONENT_DEFINE ("LteNgcE2eData");
...
class LteNgcE2eDataTestCase : public TestCase
{
public:
  LteNgcE2eDataTestCase (std::string name, std::vector<EnbTestData> v);
  virtual ~LteNgcE2eDataTestCase ();
...
LteNgcE2eDataTestCase::LteNgcE2eDataTestCase (std::string name, std::vector<EnbTestData> v)
  : TestCase (name),
    m_enbTestData (v)
{
...
LteNgcE2eDataTestCase::~LteNgcE2eDataTestCase ()
{
}

void 
LteNgcE2eDataTestCase::DoRun ()
{
  ...
  ngcHelper->SetAttribute ("S1uLinkMtu", UintegerValue (30000));
 ...
 */
class LteNgcE2eDataTestSuite : public TestSuite
{
public:
  LteNgcE2eDataTestSuite ();
  
} g_lteNgcE2eDataTestSuite;

LteNgcE2eDataTestSuite::LteNgcE2eDataTestSuite ()
  : TestSuite ("lte-ngc-e2e-data", SYSTEM)
{  
  ...
  e1.ues.push_back (u1);
  v1.push_back (e1);
  AddTestCase (new LteNgcE2eDataTestCase ("1 eNB, 1UE", v1), TestCase::QUICK);
  ...
  v2.push_back (e2);
  AddTestCase (new LteNgcE2eDataTestCase ("1 eNB, 2UEs", v2), TestCase::EXTENSIVE);

  std::vector<EnbTestData> v3;  
  v3.push_back (e1);
  v3.push_back (e2);
  AddTestCase (new LteNgcE2eDataTestCase ("2 eNBs", v3), TestCase::EXTENSIVE);
  ...
  v4.push_back (e1);
  v4.push_back (e2);
  AddTestCase (new LteNgcE2eDataTestCase ("3 eNBs", v4), TestCase::EXTENSIVE);
  ...
  v5.push_back (e5);
  AddTestCase (new LteNgcE2eDataTestCase ("1 eNB, 1UE with 1000 byte packets", v5), TestCase::EXTENSIVE);
  ...
  v6.push_back (e6);
  AddTestCase (new LteNgcE2eDataTestCase ("1 eNB, 1UE with 1400 byte packets", v6), TestCase::EXTENSIVE);
  ...
  v7.push_back (e7);
  AddTestCase (new LteNgcE2eDataTestCase ("1 eNB, 1UE with 2 bearers", v7), TestCase::EXTENSIVE);
  ...
  v8.push_back (e8);
  AddTestCase (new LteNgcE2eDataTestCase ("1 eNB, 1UE with fragmentation", v8), TestCase::EXTENSIVE);
  ...
  v9.push_back (e9);
  AddTestCase (new LteNgcE2eDataTestCase ("1 eNB, 1UE with aggregation", v9), TestCase::EXTENSIVE);
