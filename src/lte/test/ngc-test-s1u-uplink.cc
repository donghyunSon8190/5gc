...
NS_LOG_COMPONENT_DEFINE ("NgcTestS1uUplink");
...
class NgcS1uUlTestCase : public TestCase
{
public:
  NgcS1uUlTestCase (std::string name, std::vector<EnbUlTestData> v);
  virtual ~NgcS1uUlTestCase ();
...
NgcS1uUlTestCase::NgcS1uUlTestCase (std::string name, std::vector<EnbUlTestData> v)
  : TestCase (name),
    m_enbUlTestData (v)
{
}

NgcS1uUlTestCase::~NgcS1uUlTestCase ()
{
}

void 
NgcS1uUlTestCase::DoRun ()
{
 ...
 */
class NgcS1uUlTestSuite : public TestSuite
{
public:
  NgcS1uUlTestSuite ();
  
} g_ngcS1uUlTestSuiteInstance;

NgcS1uUlTestSuite::NgcS1uUlTestSuite ()
  : TestSuite ("ngc-s1u-uplink", SYSTEM)
{  
  ...
  e1.ues.push_back (f1);
  v1.push_back (e1);
  AddTestCase (new NgcS1uUlTestCase ("1 eNB, 1UE", v1), TestCase::QUICK);
  ...
  v2.push_back (e2);
  AddTestCase (new NgcS1uUlTestCase ("1 eNB, 2UEs", v2), TestCase::QUICK);


  std::vector<EnbUlTestData> v3;  
  v3.push_back (e1);
  v3.push_back (e2);
  AddTestCase (new NgcS1uUlTestCase ("2 eNBs", v3), TestCase::QUICK);
  ...
  v4.push_back (e1);
  v4.push_back (e2);
  AddTestCase (new NgcS1uUlTestCase ("3 eNBs", v4), TestCase::QUICK);
  ...
  e5.ues.push_back (f5);
  v5.push_back (e5);
  AddTestCase (new NgcS1uUlTestCase ("1 eNB, 10 pkts 3000 bytes each", v5), TestCase::QUICK);
  ...
  e6.ues.push_back (f6);
  v6.push_back (e6);
  AddTestCase (new NgcS1uUlTestCase ("1 eNB, 50 pkts 3000 bytes each", v6), TestCase::QUICK);
  ...
  e7.ues.push_back (f7);
  v7.push_back (e7);
  AddTestCase (new NgcS1uUlTestCase ("1 eNB, 10 pkts 15000 bytes each", v7), TestCase::QUICK);
  ...
  e8.ues.push_back (f8);
  v8.push_back (e8);
  AddTestCase (new NgcS1uUlTestCase ("1 eNB, 100 pkts 15000 bytes each", v8), TestCase::QUICK);
