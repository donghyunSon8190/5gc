...
PointToPointNgcHelper::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PointToPointNgcHelper")
    ...
    .AddAttribute ("S1uLinkDataRate", 
                   ...
                   MakeDataRateAccessor (&PointToPointNgcHelper::m_s1uLinkDataRate),
                   MakeDataRateChecker ())
    .AddAttribute ("S1uLinkDelay", 
                   "The delay to be used for the next S1-U link to be created",
                   TimeValue (Seconds (0)),
                   MakeTimeAccessor (&PointToPointNgcHelper::m_s1uLinkDelay),
                   MakeTimeChecker ())
...
void
PointToPointNgcHelper::AddEnb (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId)
{
...
Ptr<Node>
PointToPointNgcHelper::GetMmeNode ()
{
  return m_mmeNode;
}
