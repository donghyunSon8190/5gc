...
void
EmuNgcHelper1::AddEnb (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId)
{
 ...
 //<NgcEnbApplication> enbApp = CreateObject<NgcEnbApplication> (enbLteSocket, enbS1uSocket, enbAddress, smfAddress, cellId);
  Ptr<NgcEnbApplication1> enbApp = CreateObject<NgcEnbApplication1> (enbLteSocket, enbS1uSocket, enbAddress, smfAddress, cellId); //sjkang_x
