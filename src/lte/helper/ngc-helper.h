...
public:
   ...
   */
  virtual uint8_t ActivateEpsBearer (Ptr<NetDevice> ueLteDevice, uint64_t imsi, Ptr<NgcTft> tft, EpsBearer bearer) = 0;
   ...
   * \param bearer struct describing the characteristics of the EPS bearer to be activated
   */
  virtual uint8_t ActivateEpsBearer (Ptr<NetDevice> ueLteDevice, Ptr<NgcUeNas> ueNas, uint64_t imsi, Ptr<NgcTft> tft, EpsBearer bearer) = 0 ;//sjkang
