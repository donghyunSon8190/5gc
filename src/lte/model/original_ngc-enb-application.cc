...
NgcEnbApplication1::NgcEnbApplication1 (Ptr<Socket> lteSocket, Ptr<Socket> s1uSocket, Ipv4Address enbS1uAddress, Ipv4Address smfS1uAddress, uint16_t cellId)
    ...
    m_cellId (cellId)
{
  ...
  m_s1uSocket->SetRecvCallback (MakeCallback (&NgcEnbApplication1::RecvFromS1uSocket, this));
  m_lteSocket->SetRecvCallback (MakeCallback (&NgcEnbApplication1::RecvFromLteSocket, this));
  m_s1SapProvider = new MemberNgcEnbS1SapProvider<NgcEnbApplication1> (this);
  m_s1apSapEnb = new MemberNgcS1apSapEnb<NgcEnbApplication1> (this);
}
...
void 
NgcEnbApplication1::SetS1SapUser (NgcEnbS1SapUser * s)
{
  m_s1SapUser = s;
}
...
NgcEnbS1SapProvider* 
NgcEnbApplication1::GetS1SapProvider ()
{
  return m_s1SapProvider;
}

void 
NgcEnbApplication1::SetS1apSapMme (NgcS1apSapMme * s)
{
  m_s1apSapMme = s;
}
...
NgcS1apSapEnb* 
NgcEnbApplication1::GetS1apSapEnb ()
{
  return m_s1apSapEnb;
}
...
void 
NgcEnbApplication1::DoPathSwitchRequest (NgcEnbS1SapProvider::PathSwitchRequestParameters params)
{
  NS_LOG_FUNCTION (this);
...
void 
NgcEnbApplication1::DoInitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<NgcS1apSapEnb::ErabToBeSetupItem> erabToBeSetupList)
{
  NS_LOG_FUNCTION (this);
...
void 
NgcEnbApplication1::DoPathSwitchRequestAcknowledge (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t gci, std::list<NgcS1apSapEnb::ErabSwitchedInUplinkItem> erabToBeSwitchedInUplinkList)
{
  NS_LOG_FUNCTION (this);
...
void 
NgcEnbApplication1::RecvFromLteSocket (Ptr<Socket> socket)
{
  NS_LOG_FUNCTION (this);  
...
void 
NgcEnbApplication1::RecvFromS1uSocket (Ptr<Socket> socket)
{
...
void 
NgcEnbApplication1::SendToLteSocket (Ptr<Packet> packet, uint16_t rnti, uint8_t bid)
{
...
void 
NgcEnbApplication1::SendToS1uSocket (Ptr<Packet> packet, uint32_t teid)
{
