...
virtual  void DoReceiveAssistantInformation(NgcX2Sap::AssistantInformationForSplitting info);//sjkang1114
  ...
  virtual void DoSendHandoverRequestAckToLte (NgcX2SapProvider::HandoverRequestAckParams params);
  ...
  virtual void DoNotifyLteMmWaveHandoverCompleted (NgcX2SapProvider::SecondaryHandoverParams params);
