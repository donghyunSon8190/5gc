...
template <class C>
void
NgcX2SpecificNgcX2SapProvider<C>::SendHandoverRequestAckToLte (HandoverRequestAckParams params) //sjkang0416
{
...
template <class C>
void
NgcX2SpecificNgcX2SapProvider<C>::NotifyLteMmWaveHandoverCompleted (SecondaryHandoverParams params)
{
...
template <class C>
void
NgcX2SpecificNgcX2SapUser<C>::RecvHandoverRequestAckToLte (HandoverRequestAckParams params)
{
...
template <class C>
void
NgcX2SpecificNgcX2SapUser<C>::RecvLteMmWaveHandoverCompleted (SecondaryHandoverParams params)
{
