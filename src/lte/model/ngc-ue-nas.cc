    ...
    m_bidCounter (0)
{
  ...
  m_asSapUser = new MemberLteAsSapUser<NgcUeNas> (this);
...
void
NgcUeNas::SetAsSapProvider (LteAsSapProvider* s)
{
...
void
NgcUeNas::SetMmWaveAsSapProvider (LteAsSapProvider* s)
{
  NS_LOG_FUNCTION (this << s);
  m_mmWaveAsSapProvider = s;
}
void
NgcUeNas::SetMmWaveAsSapProvider_2 (LteAsSapProvider* s)
{
  NS_LOG_FUNCTION (this << s);
...
void
NgcUeNas::DoNotifySecondaryCellHandoverStarted (uint16_t oldRnti, uint16_t newRnti, uint16_t mmWaveCellId, LteRrcSap::RadioResourceConfigDedicated rrcd)
{
  m_mmWaveCellId = mmWaveCellId;
...
void
NgcUeNas::DoRecvRrcConnectionReconfigurationMessageforHandover(LteRrcSap::RrcConnectionReconfiguration msg){
