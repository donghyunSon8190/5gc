...
uint32_t
NgcX2HandoverRequestHeader::GetMmeUeS1apId () const
{
  return m_mmeUeS1apId;
}

void
NgcX2HandoverRequestHeader::SetMmeUeS1apId (uint32_t mmeUeS1apId)
{
...
void
NgcX2RlcSetupRequestHeader::SetLteRnti (uint16_t rnti)
{
  m_lteRnti = rnti;
}

uint16_t
NgcX2RlcSetupRequestHeader::GetLteRnti () const
{
  return m_lteRnti;
}
...
void 
NgcX2RlcSetupRequestHeader::SetLcInfo(LteEnbCmacSapProvider::LcInfo lcInfo)
{
  m_lcInfo = lcInfo;
}
...
void 
NgcX2RlcSetupRequestHeader::SetRlcConfig(LteRrcSap::RlcConfig rlcConfig)
{
...
void 
NgcX2RlcSetupRequestHeader::SetLogicalChannelConfig(LteRrcSap::LogicalChannelConfig conf)
{
  m_lcConfig = conf;
}
  ...
  for (int j = 0; j < sz; j++)
    {
      ...
      item.dlS1TnlLoadIndicator = (NgcX2Sap::LoadIndicator) i.ReadU8 ();
      item.ulS1TnlLoadIndicator = (NgcX2Sap::LoadIndicator) i.ReadU8 ();
