...
class NgcEnbApplication1 : public Application
{
  ...
  friend class MemberNgcEnbS1SapProvider<NgcEnbApplication1>;
  friend class MemberNgcS1apSapEnb<NgcEnbApplication1>;
...
public:
   ...
   */
  NgcEnbApplication1 (Ptr<Socket> lteSocket, Ptr<Socket> s1uSocket, Ipv4Address enbS1uAddress, Ipv4Address smfS1uAddress, uint16_t cellId);
