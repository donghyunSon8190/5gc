...
{
  friend class MemberNgcS11SapSmf<NgcSmfUpfApplication>;
...
public:
   ...
   */
  NgcSmfUpfApplication (const Ptr<VirtualNetDevice> tunDevice, const Ptr<Socket> s1uSocket);
   ...
   */
  void SetS11SapMme (NgcS11SapMme * s);

  /** 
   * 
   * \return the SMF side of the S11 SAP 
   */
  NgcS11SapSmf* GetS11SapSmf ();
...
private:
  ...
  // S11 SAP SMF methods
  void DoCreateSessionRequest (NgcS11SapSmf::CreateSessionRequestMessage msg);
  void DoModifyBearerRequest (NgcS11SapSmf::ModifyBearerRequestMessage msg);  

  void DoDeleteBearerCommand (NgcS11SapSmf::DeleteBearerCommandMessage req);
  void DoDeleteBearerResponse (NgcS11SapSmf::DeleteBearerResponseMessage req);
