...
public:
	...
	void ReceiveLteAssistantInfo(NgcX2Sap::AssistantInformationForSplitting info);
private:
	Ptr<LtePdcp>  m_pdcp;
};
...
void LteRlcAssistantUser::ReceiveLteAssistantInfo(NgcX2Sap::AssistantInformationForSplitting info){
...
public:
  ...
  */
  virtual void SendLteAssi(NgcX2Sap::AssistantInformationForSplitting)=0;
...
public:
  ...
  virtual void SendLteAssi(NgcX2Sap::AssistantInformationForSplitting); //sjkang
private:
...
template <class C>
void LteRlcSpecificLteRlcSapUser<C>::SendLteAssi (NgcX2Sap::AssistantInformationForSplitting info)
{
