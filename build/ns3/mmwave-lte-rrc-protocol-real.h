...
public:
  ...
  LteUeRrcSapUser* GetLteUeRrcSapUser ();
   void SendLteAssi(NgcX2Sap::AssistantInformationForSplitting); //sjkang
  void SetUeRrc (Ptr<LteUeRrc> rrc);

  void DoReceiveLteAssistantInfo(NgcX2Sap::AssistantInformationForSplitting info); //sjkang
...
public:
  ...
  void SendLteAssi(NgcX2Sap::AssistantInformationForSplitting);
