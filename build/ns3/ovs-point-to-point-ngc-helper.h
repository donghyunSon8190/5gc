...
#ifndef OVS_POINT_TO_POINT_NGC_HELPER_H
#define OVS_POINT_TO_POINT_NGC_HELPER_H
 ...
 * PointToPoint links. 
 */
class OvsPointToPointNgcHelper : public NgcHelper
{
public:
   ...
   * Constructor
   */
  OvsPointToPointNgcHelper ();

  /** 
   * Destructor
   */  
  virtual ~OvsPointToPointNgcHelper ();
