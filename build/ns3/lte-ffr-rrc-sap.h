...
template <class C>
void
MemberLteFfrRrcSapProvider<C>::RecvLoadInformation (NgcX2Sap::LoadInformationParams params)
{
...
template <class C>
void
MemberLteFfrRrcSapUser<C>::SendLoadInformation (NgcX2Sap::LoadInformationParams params)
{
