...
public: 
  ...
  void RecvHandoverRequestAckAtLte (NgcX2SapUser::HandoverRequestAckParams params); //sjkang0416
  /** 
   * 
...
class LteEnbRrc : public Object
{
  ...
  friend class MemberNgcEnbS1SapUser<LteEnbRrc>;
  friend class NgcX2SpecificNgcX2SapUser<LteEnbRrc>;
...
private:
  ...
  void DoRecvHandoverRequestAckToLte (NgcX2SapUser::HandoverRequestAckParams params); //sjkang0416
  ...
  void DoRecvLteMmWaveHandoverCompleted (NgcX2SapUser::SecondaryHandoverParams params);
