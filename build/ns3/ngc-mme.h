 ...
 *
 */
class NgcMme : public Object
{

  friend class MemberNgcS1apSapMme<NgcMme>;
  friend class MemberNgcS11SapMme<NgcMme>;
...
public:
   ...
   */
  void AddEnb (uint16_t ecgi, Ipv4Address enbS1UAddr, NgcS1apSapEnb* enbS1apSap);
